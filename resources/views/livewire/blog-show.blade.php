<div class="max-w-7xl mx-auto px-4 sm:px-6 py-12">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
        ...
        <!-- KOLOM KIRI: DETAIL ARTIKEL (Sama seperti kode awalmu dengan tweak galeri) -->
        <article class="lg:col-span-2">
            ...
            <!-- Tampilkan Semua Gambar Terkait -->
            <figure class="mb-16">
                @if ($post->images && $post->images->isNotEmpty())
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        @foreach ($post->images as $image)
                            <div
                                class="rounded-[2rem] overflow-hidden shadow-2xl shadow-blue-500/10 aspect-[16/9] bg-slate-100">
                ...
                @else
                    <div
                        class="rounded-[3rem] overflow-hidden shadow-2xl shadow-blue-500/10 aspect-[16/9] bg-slate-100 flex items-center justify-center text-slate-300">
