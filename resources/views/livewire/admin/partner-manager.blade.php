                        ...
                        <tr class="hover:bg-slate-50/30 transition-colors">
                            ...
                            <td class="p-6 text-right">
                                ...
                                <button wire:click="toggleStatus({{ $item->id }})"
                                    class="inline-flex items-center justify-center w-9 h-9 rounded-xl {{ $item->status ? 'bg-green-50 text-green-400 hover:bg-green-500 hover:text-white' : 'bg-blue-50 text-blue-400 hover:bg-blue-500 hover:text-white' }} transition-all transform active:scale-90 ml-2">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M5 13l4 4L19 7" />
                                    </svg>
