    ...
    <div class="h-[95vh] w-full bg-[#080C15] relative overflow-hidden flex flex-col">
        ...
        <section class="relative h-full w-full bg-[#0F172A] overflow-hidden group/hero font-inter"
            ...
            <div class="absolute inset-y-0 right-0 z-10 transition-all duration-700 ease-in-out group/right"
                ...
                <div
                    class="relative z-30 flex h-full flex-col justify-center items-end pr-20 text-right text-white pointer-events-none transition-transform duration-700 sm:group-hover/right:-translate-x-12">
            ...
            <div class="absolute inset-y-0 left-0 z-20 transition-all duration-700 ease-in-out group/left"
                ...
                <div
                    class="relative z-30 flex h-full flex-col justify-center items-start pl-20 text-white pointer-events-none transition-transform duration-700 sm:group-hover/left:translate-x-12">
