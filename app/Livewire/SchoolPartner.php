...
use App\Models\SchoolPartner as ModelsSchoolPartner;
...
{
    public $nama_lengkap, $nama_sekolah, $whatsapp, $email, $tujuan_surat, $penawaran;
    public $honeypot;
    ...
    public function saveMitra()
    {
        ...
        // 4. Save to Database
        ModelsSchoolPartner::create($validated);
    ...
    {
        return view('livewire.school-partner');
    }
}
